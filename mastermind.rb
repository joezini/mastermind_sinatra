...
get '/' do
	...
	if Mastermind.valid_input(guess)
		...
		@@game_over = true if black_pegs == 4
...
# Think I need to redesign the Game to be a data object:
# - Solution
# - Turn number
# - Array of prev guesses & their marks
# then the Ruby can check each guess and add new elements to the array etc.